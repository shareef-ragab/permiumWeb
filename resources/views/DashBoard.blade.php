                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span
                                    class="caption-subject font-blue-steel bold uppercase">Recent Activities</span>
                            </div>
                            <div class="actions">
                                <div class="btn-group">
                    ...
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span
                                    class="caption-subject font-purple-intense bold uppercase">General Stats</span>
                            </div>
                            <div class="actions">
                                <a href="javascript:;"
                                    ...
                                    <div class="scroller" style="height: 290px;" data-always-visible="1"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 user-info">
                                                <img alt="" src="/assets/admin/layout/img/avatar.png"
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body" id="chats">
                            <div class="scroller" style="height: 341px;" data-always-visible="1"
                                 data-rail-visible1="1">
                                <ul class="chats">
                                    <li class="in">
