<footer class="footer mt-auto py-3" style="background-color: #333333">
    <div class="container mx-auto col-sm-11">
        <div class="card-deck mx-auto mt-auto col-sm-12">
            <div class="no-gutters col-sm-1 wow fadeInUp mt-sm-4" data-wow-delay="0.6s" style="background-color: #333333;border: none">
    ...
    <div class="container mx-auto col-sm-11 ">
        <div class="card-deck">
            <div class="ml-lg-5 mt-sm-4 no-gutters wow fadeInLeft " data-wow-delay="0.6s" style="background-color: #333333;border: none">
                <p class="text-wrap text-white " style="font-size:14px; "> © 2020 Premium Development Company. All
                    rights reserved. </p>
            </div>
            <div class="ml-lg-5 mt-sm-4 no-gutters wow fadeInUp " data-wow-delay="0.6s" style="background-color: #333333;border: none">
                <p class="text-wrap text-white " style="font-size:14px;   "> About Premium Development</p>
            </div>
            <div class="ml-lg-5 mt-sm-4 no-gutters wow fadeInDown " data-wow-delay="0.6s" style="background-color: #333333;border: none">
                <p class="text-wrap text-white " style="font-size:14px;  "> About Premium Development</p>
            </div>
            <div class="ml-lg-auto mt-sm-4 no-gutters ml-lg-n5 wow fadeInRight " data-wow-delay="1.5s" style="background-color: #333333;border: none">
                <select class="custom-select-sm mr-sm-2 text-white " id="inlineFormCustomSelect"
                        style="background-color:  #333333;border: none; font-size:14px;">
