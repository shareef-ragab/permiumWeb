        ...
        <div class="card-deck no-gutters">
            <div class="col-sm-4 mb-4 mr-lg-5 ml-lg-4" >
                <div class="card bg-dark text-white size-card size-card-1 wow fadeInLeft" data-wow-delay="0.6s">
                    ...
                    <div class="card-img-overlay content ">
                        <p class="card-text font-weight-bold wow fadeInUp" data-wow-delay="0.9s">{{trans('part-home/success_stories.content_card1')}}</p>
                        ...
                        <h5 class="card-title font-weight-bold wow fadeInUp" data-wow-delay="0.7s" style="color: #FBD16B">{{trans('part-home/success_stories.title_card1')}}</h5>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mb-4 ml-lg-5 " >
                <div class="card bg-dark text-white size-card size-card-2 wow fadeInRight" data-wow-delay="0.6s">
                    ...
                    <div class="card-img-overlay content">
                        <p class="card-text font-weight-bold wow fadeInUp" data-wow-delay="0.9s">{{trans('part-home/success_stories.content_card2')}}</p>
                        <div class="text-left wow fadeInUp" data-wow-delay="0.8s" style="color: #FBD16B; border-color: #707070;opacity: 1">
                            <img class="" src="/img/Rectangle 39.png">
                        </div>
                        <h5 class="card-title font-weight-bold wow fadeInUp" data-wow-delay="0.7s" style="color: #FBD16B">{{trans('part-home/success_stories.title_card2')}}</h5>
                    </div>
                </div>
            </div>
        </div>
        <div class="card-deck no-gutters" >
            <div class="col-sm-4 mt-lg-4 mb-4 mr-lg-5 ml-lg-4 " >
                <div class="card bg-dark text-white size-card size-card-3 wow fadeInDown" data-wow-delay="0.6s">
                    ...
                    <div class="card-img-overlay content ">
                        <p class="card-text font-weight-bold wow fadeInLeft" data-wow-delay="0.9s">{{trans('part-home/success_stories.content_card3')}}</p>
                        <div class="text-left wow fadeInUp" data-wow-delay="0.8s" style="color: #FBD16B; border-color: #707070;opacity: 1">
                            <img class="" src="/img/Rectangle 39.png">
                        </div>
                        <h5 class="card-title font-weight-bold wow fadeInUp" data-wow-delay="0.7s" style="color: #FBD16B">{{trans('part-home/success_stories.title_card3')}}</h5>
                    </div>
                </div>
            </div>
            <div class="col-sm-4 mt-lg-4 card-margin ">
                <div class="card bg-dark text-white size-card size-card-3 wow fadeInDown" data-wow-delay="0.6s" >
                    <img src="/img/clement-h-2.png" class="card-img size-card-3 " alt="...">
                    <div class="card-img-overlay content">
                        <p class="card-text font-weight-bold wow fadeInLeft" data-wow-delay="0.9s">{{trans('part-home/success_stories.content_card4')}}</p>
                        <div class="text-left wow fadeInUp" data-wow-delay="0.8s" style="color: #FBD16B; border-color: #707070;opacity: 1">
                            <img class="" src="/img/Rectangle 39.png">
                        </div>
                        <h5 class="card-title font-weight-bold wow fadeInUp" data-wow-delay="0.7s" style="color: #FBD16B">{{trans('part-home/success_stories.title_card4')}}</h5>
                    </div>
                </div>
            </div>
        </div>
