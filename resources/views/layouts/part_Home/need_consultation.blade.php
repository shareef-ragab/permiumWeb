...
<div class="container-fluid card-group mt-lg-5">
    <div class="no-gutters ">
        <div class="text-left ml-lg-5 mt-lg-n3 font-weight-bold text-uppercase"
             style="font-size: 30px">{{trans('APP.need_consultation')}}</div>
        ...
        <div class="col-12 text-left ml-lg-5 mt-lg-5 text-uppercase font-weight-bold mb-lg-5 ">
            <a class="pl-lg-5 pr-lg-5 pt-lg-2 pb-lg-2  w-75 mouse_contact_revert" href="#"
