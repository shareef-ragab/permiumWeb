    ...
    <div class="row no-gutters mt-lg-5">
        ...
        <div class="col-md-8 wow fadeInRight" data-wow-delay="0.5s">
            <div class="card-body">
                ...
                <div class="text-left ml-lg-5 mt-lg-5 fadeInUp" data-wow-delay="1.3s" style="font-size: 18px">{{trans('APP.content_managed_services')}}</div>
            </div>
            <div class="text-right mr-lg-auto mr-lg-5 card-link-manged">
                <a href="#" class="mr-lg-5 fadeInRight" data-wow-delay="1.5s" style="color: #FBD16B; ">{{trans('APP.Learn_More')}}<img
